...
def trim_farthest_city(plan: Plan, vtds: List[int], x_abs: float,
                       y_abs: float) -> Optional[str]:
    """
    ...
    city_count = len(
        set([plan.graph.indices['vtd_to_city'][vtd] for vtd in vtds]))
...
def trim_farthest_vtd(plan: Plan, vtds: List[int], x_abs: float,
                      y_abs: float) -> Optional[int]:
    """
...
def _farthest_vtds(plan: Plan, vtds: List[int], x_abs: float,
                   y_abs: float) -> List[int]:
    """
